...
class JSONUtils {
  ...
  public static AnimatedSprite getAnimatedSpriteFromJson(JSONObject json,
      String path) {
    double cycleTime =
        ((Number) getFromComplexPath(json, path + "cycleTime")).doubleValue();
  ...
  public static List<AnimatedSprite> getAnimatedSpritesFromJson(JSONObject json,
      String path) {
  ...
  public static AudioClip getAudioClipFromJson(JSONObject json, String path) {
    File soundPath =
        new File((String) JSONUtils.getFromComplexPath(json, path));
