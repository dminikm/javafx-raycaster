...
public class TurretEntity extends MonsterEntity {
  TurretEntity(Vec2 pos, AnimatedSprite animation, AnimatedSprite deadSprite,
      AudioClip hurtSound, AudioClip firingSound) {
  ...
  public Sprite getSprite() {
    return (this.health > 0)
        ? this.animation.getSprite(this.position.copy(), false)
